...
public interface PersonalBooksRepository extends JpaRepository<PersonalBook, Long> {
    ...
    @Query(value = "SELECT pb FROM PersonalBook pb WHERE pb.customer = :customer AND pb.book.isbn = :isbn")
    Optional<PersonalBook> findPersonalBookByCustomer(Customer customer, String isbn);
