...
('customer', 'techguru', '2024-04-12', 'USA', 'Tech enthusiast and blogger', 'techguru@example.com', 'male', 'Technology, Gadgets, Coding', 'John Doe', 'securepassword123', 'https://example.com/banners/techguru.jpg', 'https://randomuser.me/api/portraits/men/1.jpg', 'he/him'),
