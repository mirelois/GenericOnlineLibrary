...
docker exec -it postgres psql -U postgres -d cool -c "INSERT INTO book (isbn, description, image_url, launch_date, title, total_page_numbers, author_username, publisher_name) VALUES
