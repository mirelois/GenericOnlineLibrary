...
import com.aa.coolreads.Book.models.GenreType;
...
public class BookMapper {
    ...
    public BookDTO toBookDTO(Book book) {
        Set<String> genres = book.getGenres().stream().map(Genre::getGenreType).map(GenreType::toString).collect(Collectors.toSet());
